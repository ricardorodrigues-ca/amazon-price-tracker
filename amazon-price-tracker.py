...
# Note:         They no longer allow us to scrape using the Requests module, so we use Selenium now
# Created:      2020-05-20
...
# run Chrome headless so we don't have to manage multiple open windows/tabs
